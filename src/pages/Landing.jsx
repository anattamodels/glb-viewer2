...
const styles = {
  ...
  btnAdd: { background: '#4CAF50', padding: '12px', borderRadius: '5px', cursor: 'pointer', textAlign: 'center', fontWeight: 'bold', color: 'white', display: 'block' },
  btnAction: { background: '#333', border: '1px solid #444', color: 'white', padding: '10px', borderRadius: '5px', cursor: 'pointer', textAlign: 'left', transition: '0.2s', fontSize: '1rem', width: '100%' },
